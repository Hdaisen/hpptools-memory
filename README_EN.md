...
📊 **[Component structure (EN)](docs/architecture.en.html)** — static module & vault layout
📊 **[Runtime mechanics (EN)](docs/turn-lifecycle.en.html)** — full memory lifecycle of one turn

> The diagrams are interactive HTML files (zoom, focus, light/dark themes), generated by archify.
