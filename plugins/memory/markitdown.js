// markitdown.js — Port of pi-memory-system extensions/memory/markitdown.ts
// Converts binary files (PDF, DOCX, etc.) to Markdown via MarkItDown.
// On Windows: uses WSL (markitdown in ~/.markitdown-venv/).
 ...
 */
export function ensureWslSymlink() {
