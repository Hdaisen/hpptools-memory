window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const memoryApi = {
			overview: (signal) => memoryFetch("overview", {
				cache: "no-store",
				signal
			}),
			...
			files: (signal) => memoryFetch("files", {
				cache: "no-store",
				signal
			}),
			...
			clean: () => memoryFetch("clean", { method: "POST" }),
		...
		*/
		...
		function Files({ visible }) {
			...
			const loadFiles = (0, react.useCallback)(() => {
				memoryApi.files().then(setFiles).catch((e) => {
					setStatus({
		...
		function MemoryView(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					view === "overview" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Overview, { visible }),
					view === "files" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Files, { visible }),
					view === "models" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Models, {}),
					view === "runs" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Runs, { visible }),
