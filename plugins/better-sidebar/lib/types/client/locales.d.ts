...
export declare const zh: {
    ...
    memNavModels: string;
    memNavRuns: string;
    memNavSettings: string;
    memLoading: string;
    memUnitFiles: string;
    memUnitEntries: string;
    memUnitProjects: string;
    memUnitSkills: string;
    memUnitCount: string;
    memRunning: string;
    memOverviewFailed: string;
    memNoProject: string;
    memNoSession: string;
    memNeverCleaned: string;
    memCardCurProject: string;
    memCardAllProjects: string;
    memCardGlobal: string;
    memCardMaintenance: string;
    memCardActiveRuns: string;
    memCardExtractor: string;
    memCardCleaner: string;
    memCardCurSub: string;
    memCardAllSub: string;
    memCardPersonalDir: string;
    memCardMaintenanceDir: string;
    memCardExtractorSub: string;
    memCardCleanerSub: string;
    memMigDetected: string;
    memMigrateNow: string;
    memMigrated: string;
    memMigrateDone: string;
    memSelectHint: string;
    memEmptyGroup: string;
    memLoaded: string;
    memSaved: string;
    memEdit: string;
    memPreview: string;
    ...
    memCancel: string;
    memEntryNav: string;
    memSubagentModels: string;
    memExtractorModel: string;
    memCleanerModel: string;
    memSaveModels: string;
    memModelsLoaded: string;
    memModelsSaved: string;
    memModelSourceHint: string;
    memRunsHint: string;
    memRunClean: string;
    ...
    memColReason: string;
    memNoRuns: string;
    memBadgeRunning: string;
    memBadgeDone: string;
    memBadgeFailed: string;
    memStorageTitle: string;
    memCurrentPath: string;
    memNewPath: string;
    memSaveRoot: string;
    memCopyData: string;
    memRootHint: string;
    memRootPlaceholder: string;
    memRootSaved: string;
    memRootSavedCopied: string;
    memRootEmpty: string;
    memMigrationTitle: string;
    memMigrateNone: string;
    memObsidianTitle: string;
    memObsidianHintText: string;
    memOpenFolder: string;
};
